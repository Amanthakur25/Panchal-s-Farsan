...
const NamkeenPage = () => {
  ...
  const namkeenProducts = products.filter(product => 
    product.category.toLowerCase().includes('namkeen') ||
    product.category.toLowerCase().includes('snack') ||
    product.category.toLowerCase().includes('sev') ||
    product.category.toLowerCase().includes('chips') ||
    product.category.toLowerCase().includes('nuts')
  );
  ...
  const subCategories = ['all', ...new Set(namkeenProducts.map(p => p.subCategory).filter(Boolean) as string[])];

  // Apply filters
  let filteredProducts = [...namkeenProducts];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">Snacks</span>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Snacks</h1>
