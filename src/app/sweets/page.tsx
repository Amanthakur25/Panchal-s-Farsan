...
const SweetsPage = () => {
  // Filter products for sweets category
  const sweetsProducts = products.filter(product => 
    ...
    product.category.toLowerCase().includes('burfi') ||
    product.category.toLowerCase().includes('ladoo')
  );
  ...
  const subCategories = ['all', ...new Set(sweetsProducts.map(p => p.subCategory).filter(Boolean) as string[])];

  // Apply filters
  let filteredProducts = [...sweetsProducts];
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-6 text-sm text-gray-600">
        ...
        <span className="text-gray-900 font-medium">Sweets</span>
      </div>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-bold text-gray-800">Sweets</h1>
